...
def handle_all_messages(message):
    ...
    if text == "📊 وضعیت من و رتبه":
        ...
        guide_text = (
            ...
            f"3. آدرس قرارداد (Contract Address) توکن پرسپولیس را در کادر مربوطه وارد کنید.\n"
            f"4. **دقت کنید که نام کامل آن حتماً PERSEPOLIS باشد.**\n"
            f"5. روی گزینه **Save** یا **Add Token** بزنید تا توکن اضافه شود.\n\n"
